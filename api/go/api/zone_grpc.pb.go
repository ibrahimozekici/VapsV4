...
const (
	ZoneService_Create_FullMethodName = "/api.ZoneService/Create"
	ZoneService_Get_FullMethodName    = "/api.ZoneService/Get"
	ZoneService_List_FullMethodName   = "/api.ZoneService/List"
	ZoneService_Delete_FullMethodName = "/api.ZoneService/Delete"
	ZoneService_Update_FullMethodName = "/api.ZoneService/Update"
)
