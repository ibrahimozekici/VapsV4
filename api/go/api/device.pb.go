...
const file_api_device_proto_rawDesc = "" +
	...
	"\rbattery_level\x18\x03 \x01(\x02R\fbatteryLevel\"\xa7\x03\n" +
	...
	"\rdevice_status\x18\t \x01(\v2\x11.api.DeviceStatusR\fdeviceStatus\"W\n" +
	"\n" +
	"DeviceKeys\x12\x17\n" +
	"\adev_eui\x18\x01 \x01(\tR\x06devEui\x12\x17\n" +
	"\anwk_key\x18\x02 \x01(\tR\x06nwkKey\x12\x17\n" +
	"\aapp_key\x18\x03 \x01(\tR\x06appKey\":\n" +
	...
	"\adev_eui\x18\x01 \x01(\tR\x06devEui\"\xaf\x01\n" +
	...
	"\x11io.chirpstack.apiB\vDeviceProtoP\x01Z.github.com/ibrahimozekici/VapsV4/api/go/v4/api\xaa\x02\x0eChirpstack.Api\xca\x02\x0eChirpstack\\Api\xe2\x02\x1aGPBMetadata\\Chirpstack\\Apib\x06proto3"
