...
impl DeviceProfileService for DeviceProfile {
    async fn create(
        ...
        let mut dp = device_profile::DeviceProfile {
            ...
            class_b_timeout: Some(req_dp.class_b_timeout as i32),
            class_b_ping_slot_nb_k: Some(req_dp.class_b_ping_slot_nb_k as i32),
            class_b_ping_slot_dr: Some(req_dp.class_b_ping_slot_dr as i16),
            class_b_ping_slot_freq: Some(req_dp.class_b_ping_slot_freq as i64),
            class_c_timeout: Some(req_dp.class_c_timeout as i32),
            abp_rx1_delay: Some(req_dp.abp_rx1_delay as i16),
            abp_rx1_dr_offset: Some(req_dp.abp_rx1_dr_offset as i16),
            abp_rx2_dr: Some(req_dp.abp_rx2_dr as i16),
            abp_rx2_freq: Some(req_dp.abp_rx2_freq as i64),
            ...
            is_relay: Some(req_dp.is_relay),
            is_relay_ed: Some(req_dp.is_relay_ed),
            relay_ed_relay_only: Some(req_dp.relay_ed_relay_only),
            relay_enabled: Some(req_dp.relay_enabled),
            relay_cad_periodicity: Some(req_dp.relay_cad_periodicity as i16),
            relay_default_channel_index: Some(req_dp.relay_default_channel_index as i16),
            relay_second_channel_freq: Some(req_dp.relay_second_channel_freq as i64),
            relay_second_channel_dr: Some(req_dp.relay_second_channel_dr as i16),
            relay_second_channel_ack_offset: Some(req_dp.relay_second_channel_ack_offset as i16),
            relay_ed_activation_mode: Some(req_dp.relay_ed_activation_mode().from_proto() as i16),
            relay_ed_smart_enable_level: Some(req_dp.relay_ed_smart_enable_level as i16),
            relay_ed_back_off: Some(req_dp.relay_ed_back_off as i16),
            relay_ed_uplink_limit_bucket_size: Some(
                req_dp.relay_ed_uplink_limit_bucket_size as i16,
            ),
            relay_ed_uplink_limit_reload_rate: Some(
                req_dp.relay_ed_uplink_limit_reload_rate as i16,
            ),
            relay_join_req_limit_reload_rate: Some(req_dp.relay_join_req_limit_reload_rate as i16),
            relay_notify_limit_reload_rate: Some(req_dp.relay_notify_limit_reload_rate as i16),
            relay_global_uplink_limit_reload_rate: Some(
                req_dp.relay_global_uplink_limit_reload_rate as i16,
            ),
            relay_overall_limit_reload_rate: Some(req_dp.relay_overall_limit_reload_rate as i16),
            relay_join_req_limit_bucket_size: Some(req_dp.relay_join_req_limit_bucket_size as i16),
            relay_notify_limit_bucket_size: Some(req_dp.relay_notify_limit_bucket_size as i16),
            relay_global_uplink_limit_bucket_size: Some(
                req_dp.relay_global_uplink_limit_bucket_size as i16,
            ),
            relay_overall_limit_bucket_size: Some(req_dp.relay_overall_limit_bucket_size as i16),
    ...
    async fn get(
        ...
        let mut resp = Response::new(api::GetDeviceProfileResponse {
            device_profile: Some(api::DeviceProfile {
                ...
                class_b_timeout: dp.class_b_timeout.unwrap_or(0) as u32,
                class_b_ping_slot_nb_k: dp.class_b_ping_slot_nb_k.unwrap_or(0) as u32,
                class_b_ping_slot_dr: dp.class_b_ping_slot_dr.unwrap_or(0) as u32,
                class_b_ping_slot_freq: dp.class_b_ping_slot_freq.unwrap_or(0) as u32,
                class_c_timeout: dp.class_c_timeout.unwrap_or(0) as u32,
                abp_rx1_delay: dp.abp_rx1_delay.unwrap_or(0) as u32,
                abp_rx1_dr_offset: dp.abp_rx1_dr_offset.unwrap_or(0) as u32,
                abp_rx2_dr: dp.abp_rx2_dr.unwrap_or(0) as u32,
                abp_rx2_freq: dp.abp_rx2_freq.unwrap_or(0) as u32,
                ...
                is_relay: dp.is_relay.unwrap_or(false),
                is_relay_ed: dp.is_relay_ed.unwrap_or(false),
                relay_ed_relay_only: dp.relay_ed_relay_only.unwrap_or(false),
                relay_enabled: dp.relay_enabled.unwrap_or(false),
                relay_default_channel_index: dp.relay_default_channel_index.unwrap_or(0) as u32,
                relay_second_channel_freq: dp.relay_second_channel_freq.unwrap_or(0) as u32,
                relay_second_channel_dr: dp.relay_second_channel_dr.unwrap_or(0) as u32,
                relay_second_channel_ack_offset: dp.relay_second_channel_ack_offset.unwrap_or(0)
                    as i32,
                relay_ed_smart_enable_level: dp.relay_ed_smart_enable_level.unwrap_or(0) as u32,
                relay_ed_back_off: dp.relay_ed_back_off.unwrap_or(0) as u32,
                relay_ed_uplink_limit_bucket_size: dp.relay_ed_uplink_limit_bucket_size.unwrap_or(0)
                    as u32,
                relay_ed_uplink_limit_reload_rate: dp.relay_ed_uplink_limit_reload_rate.unwrap_or(0)
                    as u32,
                relay_join_req_limit_reload_rate: dp.relay_join_req_limit_reload_rate.unwrap_or(0)
                    as u32,
                relay_notify_limit_reload_rate: dp.relay_notify_limit_reload_rate.unwrap_or(0)
                    as u32,
                relay_global_uplink_limit_reload_rate: dp
                    .relay_global_uplink_limit_reload_rate
                    .unwrap_or(0) as u32,
                relay_overall_limit_reload_rate: dp.relay_overall_limit_reload_rate.unwrap_or(0)
                    as u32,
                relay_join_req_limit_bucket_size: dp.relay_join_req_limit_bucket_size.unwrap_or(0)
                    as u32,
                relay_notify_limit_bucket_size: dp.relay_notify_limit_bucket_size.unwrap_or(0)
                    as u32,
                relay_global_uplink_limit_bucket_size: dp
                    .relay_global_uplink_limit_bucket_size
                    .unwrap_or(0) as u32,
                relay_overall_limit_bucket_size: dp.relay_overall_limit_bucket_size.unwrap_or(0)
                    as u32,
                allow_roaming: dp.allow_roaming,
                rx1_delay: dp.rx1_delay as u32,
                relay_cad_periodicity: dp.relay_cad_periodicity.unwrap_or(0) as i32,
                relay_ed_activation_mode: dp.relay_ed_activation_mode.unwrap_or(0) as i32,                
            }),
